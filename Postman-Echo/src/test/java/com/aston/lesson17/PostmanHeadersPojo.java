...
public class PostmanHeadersPojo {
    private String host;
    ...
    public PostmanHeadersPojo() {
    }

    public PostmanHeadersPojo(String host, String forwardedProto, String forwardedPort, String contentType,
                              String userAgent, String acceptEncoding) {
        this.host = host;
